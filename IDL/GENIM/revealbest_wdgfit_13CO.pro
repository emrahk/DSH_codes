pro revealbest_wdgfit_13CO, inpstr, dist, numim=imnum, ds9=ds9, plthist=plthist
...
;rename input structure to keep original
  ...
  IF plthist THEN BEGIN
        fitsfile='/data3/efeoztaban/E2_simulations_13CO_corrected/'+sdist+'/'+sdist1+'.'+sdist2+'_'+sclouds+'E2.fits'
